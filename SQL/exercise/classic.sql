-- 参考页面 https://blog.csdn.net/original_recipe/article/details/91958663
-- https://blog.csdn.net/weixin_43930865/article/details/89525700


-- 1. 查询" 01 "课程比" 02 "课程成绩高的学生的信息及课程分数 
-- 1.1 查询同时存在" 01 "课程和" 02 "课程的情况
SELECT t1.*, t2.* FROM classic_exercises.Student t1
INNER JOIN
(SELECT a.SId, a.score score1, b.score score2 FROM SC a, SC b WHERE a.score > b.score AND a.SId = b.SId AND a.CId = '01' AND b.CId = '02') t2
ON t1.SId = t2.SId
