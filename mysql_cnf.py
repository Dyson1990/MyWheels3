...
"""
    ...
    "thread_concurrency": psutil.cpu_count() * 2,
...
"""
    ...
    "key_buffer_size": psutil.virtual_memory().total / 16,
...
"""
    "innodb_buffer_pool_size": psutil.virtual_memory().total - 3 * pow(1024, 3),
    
    # 网络传输中一次消息传输量的最大值。系统默认值为1MB，最大值是1GB，必须设置1024的倍数。
    "innodb_additional_mem_pool_size": "16M",
    
    "innodb_read_io_threads ": psutil.cpu_count() / 2,
    "innodb_write_io_threads ": psutil.cpu_count() / 2,
...
with codecs.open(r'C:\Users\gooddata\mysqld.cnf', 'w', 'utf-8') as fp:
